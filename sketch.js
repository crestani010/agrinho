let perguntas = [
  {
    pergunta: "qual ambiente é conhecido por oferecer uma vida mais tranquila e próxima à natureza?",
    opcoes: [
      "cidade",
      "campo",
    ],
  ...
  {
    pergunta: "qual lugar costuma proporcionar um ar mais puro e menos poluído?",
    opcoes: [
      "cidade",
      "campo",
    ],
  ...
  {
    pergunta: "qual lugar vai proporcionar uma sensação de liberdade?",
    opcoes: [
      "cidade",
      "campo",
    ],
  ...
  {
    pergunta: "qual lugar vai te deixar mais perto das plantaçoẽs agriculas?",
    opcoes: [
      "cidade",
      "Campo",
    ],
  ...
  {
    pergunta: "qual lugar oferece contato com animais?",
    opcoes: [
      "cidade",
      "campo",
    ],
